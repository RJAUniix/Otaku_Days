...
nextBtn.addEventListener(
    ...
    (displayNext = () => {
        ...
        if (questionCount == 10 ) {
            ...
            //user score
            if(scoreCount <= 10) {
                userScore.innerHTML = "Pas ouf🥱, Votre score est de " + scoreCount + " sur " + questionCount;
            }
            else if(scoreCount <= 10) {
                userScore.innerHTML = "Pas mal😊, Votre score est de " + scoreCount + " sur " + questionCount;
            }
            else{
                userScore.innerHTML = "Bravo🤩, Votre score est de " + scoreCount + " sur " + questionCount;
            }
            scorer();
        } else {
            //display questionCount
            countOfQuestion.innerHTML =
                questionCount + 1 + " of " + "10" + " Question";
            //display quiz
...
function quizCreator() {
    ...
    for (let i of quizArray) {
        ...
        //question number
        countOfQuestion.innerHTML = 1 + " of " + "10" + " Question";
        //question
